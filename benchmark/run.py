...
from benchmark.datasets import ManifestError, load_manifest, load_transcript, prepare_manifest
from benchmark.instrumentation import EventCapture
...
from benchmark.metrics import aggregate_results, parse_junit_totals
from benchmark.reference_free.alignscore_runner import (
    AlignScoreRunner,
...
from benchmark.reference_free.judge_runner import (
    LLMJudgeRunner,
    LLMJudgeRunnerConfig,
)
from benchmark.reference_free.pipeline import (
    ReferenceFreePipeline,
    ReferenceFreePipelineConfig,
)
from benchmark.types import BenchmarkReport, CellRunResult, ProviderProfile, SampleRunResult
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    execute.add_argument(
        "--manifest",
        default="benchmark/manifests/benchmark_v1.json",
    ...
    execute.add_argument(
        "--provider-profiles",
        default="benchmark/provider_profiles.yaml",
    ...
    execute.add_argument(
        "--judge-rubric",
        default="benchmark/rubrics/default_summarization_rubric.json",
    ...
    if provider_filter is not None:
        ...
        profiles = [
            ProviderProfile(
                ...
                description="Configured default provider from conf/config.yaml",
