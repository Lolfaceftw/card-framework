...
<codebaseGuide workspace="llm_test" package="card-framework" language="Python" pythonVersion="3.12+" packageManager="uv" linter="ruff">
  ...
  <section id="providers-config-and-commands" title="Providers, Config, And Commands">
    ...
    <commandNotes>
      ...
      <note>The public PyPI project already exists as of March 9, 2026. `1.0.1` is the first published version, `v1.0.2` failed PyPI publication, `1.0.3` is the current recovery release, and the next packaging fix must advance to a new version such as `1.0.4` instead of reusing a prior version number.</note>
