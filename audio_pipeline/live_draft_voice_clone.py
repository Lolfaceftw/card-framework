...
from audio_pipeline.runtime import probe_audio_duration_ms
from audio_pipeline.voice_clone_contracts import VoiceCloneArtifact, VoiceCloneProvider
...
def _snapshot_matches_summary_xml(
    ...
    from summary_xml import parse_summary_xml
