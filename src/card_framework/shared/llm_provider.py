...
class ToolDefinition:
    """Typed tool definition used for function-calling capable card_framework.providers."""
...
class LLMResponseCallback(Protocol):
    """Callback protocol for streaming token/thought updates from card_framework.providers."""
