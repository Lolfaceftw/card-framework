...
def build_embedding_profiles(base_cfg: DictConfig) -> dict[str, EmbeddingProfile]:
    ...
    disabled = EmbeddingProfile(
        ...
        embedding_config={"_target_": "card_framework.providers.null_provider.NoOpEmbeddingProvider"},
    )
